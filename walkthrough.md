...
*   **Matriz de Stock y Cobertura (ERP PDF)**:
    ...
    *   **Maquetación Visual**: Representa la cobertura física en una cuadrícula bidimensional cruzando **Marcas (Filas)** contra **Capacidades (Columnas)**. Cada celda de cruce contiene tres luces indicadoras redondas e independientes correspondientes a las gamas **E (Económica)**, **M (Media)** y **P (Premium)**, que muestran de un vistazo la cobertura de cada segmento de precio mediante un código de colores semáforo interactivo. También incluye un panel lateral de cuotas de inventario por marca.
