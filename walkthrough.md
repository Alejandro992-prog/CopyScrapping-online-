...
*   **Matriz de Stock y Cobertura (ERP PDF)**:
    ...
    *   **Maquetación Visual**: Representa la cobertura física en una cuadrícula bidimensional cruzando **Marcas (Filas)** contra **Capacidades (Columnas)** con un código de colores semáforo interactivo y un panel lateral de cuotas de inventario por marca.
